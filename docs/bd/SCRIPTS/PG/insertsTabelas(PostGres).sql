...
('Desenvolvimento de Software', 'Projectos, linguagens de programa��o e frameworks'),
('Infraestrutura de TI', 'Servidores, redes e gest�o de sistemas'),
('Ciberseguran�a', 'Protec��o de dados, firewalls e controlo de acessos'),
('Suporte T�cnico', 'Assist�ncia a utilizadores e resolu��o de problemas'),
('Inova��o e I&D', 'Investiga��o, prot�tipos e novas tecnologias');
...
(1, 'Backend', 'L�gica de servidor e integra��o com bases de dados'),
(1, 'Mobile', 'Aplica��es para Android e iOS'),
(2, 'Servidores', 'Gest�o e monitoriza��o de servidores f�sicos e virtuais'),
(2, 'Redes', 'Configura��o e manuten��o de redes empresariais'),
(3, 'An�lise de Vulnerabilidades', 'Identifica��o de falhas de seguran�a'),
(3, 'Gest�o de Acessos', 'Controlo de permiss�es e autentica��es'),
(4, 'Helpdesk', 'Atendimento e apoio t�cnico aos utilizadores'),
(4, 'Manuten��o de Equipamentos', 'Gest�o e repara��o de hardware'),
(5, 'Intelig�ncia Artificial', 'Investiga��o e desenvolvimento em IA e Machine Learning');
...
(1, 'UX/UI Design', 'Melhoria da experi�ncia do utilizador'),
(2, 'APIs REST', 'Desenvolvimento de servi�os web RESTful'),
(2, 'ORMs', 'Mapeamento objeto-relacional com frameworks como Hibernate'),
(3, 'Flutter', 'Framework da Google para aplica��es m�veis'),
(4, 'Virtualiza��o', 'Uso de m�quinas virtuais em servidores empresariais'),
(5, 'VPNs Empresariais', 'Redes privadas virtuais para seguran�a de dados'),
(6, 'Pentesting', 'Testes de intrus�o para avalia��o da seguran�a'),
(8, 'Suporte Remoto', 'Assist�ncia t�cnica � dist�ncia via software'),
...
(1, 1, 1, 1, 1, 'Curso React', 'Base React JS', 20, '2024-05-01', '2024-06-01', 2, 1, 'Portugu�s', 40.0, 5, 'react.jpg'),
(2, 2, 2, 1, 1, 'Curso UX/UI', 'Design para apps', 15, '2024-04-20', '2024-05-20', 2, 1, 'Portugu�s', 30.0, 3, 'uxui.jpg'),
(3, 3, 3, 2, 2, 'API RESTful', 'Integra��es web', 25, '2024-04-15', '2024-05-15', 2, 1, 'Portugu�s', 35.0, 6, 'api.jpg'),
(4, 4, 4, 2, 2, 'ORM Avan�ado', 'Frameworks ORM', 10, '2024-06-01', '2024-07-01', 1, 1, 'Portugu�s', 20.0, 2, 'orm.jpg'),
(5, 5, 5, 3, 3, 'Flutter Mobile', 'Apps multiplataforma', 18, '2024-05-10', '2024-06-10', 3, 1, 'Portugu�s', 38.0, 4, 'flutter.jpg'),
(6, 1, 1, 4, 4, 'Virtualiza��o', 'Servidores virtuais', 12, '2024-05-05', '2024-06-05', 2, 1, 'Portugu�s', 25.0, 4, 'vm.jpg'),
(7, 2, 2, 5, 5, 'VPN Segura', 'Prote��o de redes', 20, '2024-05-15', '2024-06-20', 1, 1, 'Portugu�s', 28.0, 3, 'vpn.jpg'),
(8, 3, 3, 5, 6, 'Teste Penetra��o', 'Seguran�a ativa', 15, '2024-05-02', '2024-06-12', 2, 1, 'Portugu�s', 32.0, 2, 'pentest.jpg'),
(9, 4, 4, 2, 8, 'Suporte Remoto', 'Assist�ncia t�cnica', 30, '2024-04-25', '2024-05-25', 2, 1, 'Portugu�s', 26.0, 5, 'suporte.jpg'),
(10, 5, 5, 3, 10, 'Redes Neuronais', 'IA aplicada', 10, '2024-06-01', '2024-07-10', 3, 1, 'Portugu�s', 40.0, 1, 'neural.jpg');
...
(1, 1, 1, 1, 1, 'React - Aulas Gravadas', 'Vers�o v�deo', 50, '2024-05-02', '2024-07-02', 2, 1, 'Portugu�s', 40.0, 12, 'react_async.jpg'),
(2, 2, 1, 1, 1, 'UX/UI Avan�ado', 'Grava��es interativas', 40, '2024-04-21', '2024-06-15', 2, 1, 'Portugu�s', 30.0, 10, 'uxui_async.jpg'),
(3, 3, 1, 2, 2, 'RESTful API V�deo', 'Acesso sob demanda', 60, '2024-04-16', '2024-06-16', 2, 1, 'Portugu�s', 35.0, 14, 'api_async.jpg'),
(4, 4, 1, 2, 2, 'ORM Autodidata', 'Conte�do modular', 25, '2024-06-02', '2024-07-30', 2, 1, 'Portugu�s', 20.0, 6, 'orm_async.jpg'),
(5, 5, 1, 3, 3, 'Flutter On Demand', 'Curso online', 30, '2024-05-11', '2024-06-30', 2, 1, 'Portugu�s', 38.0, 9, 'flutter_async.jpg'),
(6, 6, 2, 4, 4, 'Virtualiza��o Self-Paced', 'Aprendizagem livre', 20, '2024-05-06', '2024-06-25', 2, 1, 'Portugu�s', 25.0, 7, 'vm_async.jpg'),
(7, 7, 2, 5, 5, 'VPN Essencial', 'Forma��o ass�ncrona', 30, '2024-05-16', '2024-07-01', 2, 1, 'Portugu�s', 28.0, 5, 'vpn_async.jpg'),
(8, 8, 2, 5, 6, 'Pentest Ass�ncrono', 'V�deos e exerc�cios', 25, '2024-05-03', '2024-06-30', 2, 1, 'Portugu�s', 32.0, 4, 'pentest_async.jpg'),
(9, 9, 2, 2, 8, 'Suporte T�cnico V�deo', 'Acesso 24h', 35, '2024-04-26', '2024-06-20', 2, 1, 'Portugu�s', 26.0, 8, 'suporte_async.jpg'),
(10, 10, 2, 3, 10, 'IA Neuronal V�deo', 'Curso ass�ncrono', 20, '2024-06-02', '2024-08-01', 2, 1, 'Portugu�s', 40.0, 3, 'neural_async.jpg');
...
(2, 2, 1, 'UX: Melhores Pr�ticas', '2024-04-25'),
(3, 3, 2, 'API REST: Boas Pr�ticas', '2024-04-18'),
(4, 4, 2, 'ORM com exemplos pr�ticos', '2024-05-03'),
(5, 5, 3, 'Introdu��o ao Flutter', '2024-04-27'),
(6, 6, 4, 'Manual de Virtualiza��o', '2024-05-06'),
(7, 7, 5, 'Configura��o de VPNs', '2024-05-09'),
(8, 8, 5, 'Pentesting com Kali Linux', '2024-04-30'),
(9, 9, 2, 'FAQ de Suporte T�cnico', '2024-05-02'),
(10, 10, 3, 'Bases de Intelig�ncia Artificial', '2024-05-10');
...
(1, 1, 'Aprendi hoje sobre componentes em React! Incr�vel!', 120, 15),
(2, 2, 'UX n�o � s� sobre design, � sobre experi�ncia. Fa�am o teste!', 200, 25),
(3, 3, 'As melhores pr�ticas para criar uma API RESTful de sucesso!', 150, 10),
(4, 4, 'Configura��o de ORM foi mais f�cil do que eu pensava, recomendo!', 95, 5),
(5, 5, 'A primeira app em Flutter j� est� no ar. Super f�cil de come�ar!', 130, 18),
(1, 6, 'Virtualizar sistemas nunca foi t�o acess�vel. Vamos l�!', 80, 12),
(2, 7, 'VPNs: essencial para seguran�a, mas com a configura��o certa!', 110, 22),
(3, 8, 'Pentesting � emocionante! Kali Linux est� em alta!', 170, 30),
(4, 9, 'Suporte t�cnico eficiente � a chave para a satisfa��o do cliente.', 140, 20),
(5, 10, 'Entendendo a IA: n�o � fic��o cient�fica, est� aqui agora.', 250, 35);
...
(1, 1, 1, '�timo post sobre React! Muito �til para iniciantes.', 15),
(2, 2, 2, 'Excelente conte�do sobre UX. Vou aplicar no meu projeto.', 20),
(3, 3, 3, 'Achei o post interessante, mas poderia ser mais aprofundado.', 8),
(4, 4, 4, 'Adorei as dicas sobre ORM! Muito bem explicado.', 12),
(5, 5, 5, 'Flutter � realmente incr�vel, mas ainda estou aprendendo.', 25),
(6, 1, 6, 'A explica��o sobre virtualiza��o n�o ficou clara para mim.', 3),
(7, 2, 7, 'VPNs s�o essenciais para seguran�a, �timas dicas!', 18),
(8, 3, 8, 'Pentesting � um tema interessante, mas o post n�o trouxe novidades.', 7),
(9, 4, 9, 'Excelente abordagem ao suporte t�cnico. Vou seguir essas dicas.', 10),
(10, 5, 10, 'Intelig�ncia artificial � o futuro, mas este post � muito superficial.', 5);
...
(1, 1, 'Introdu��o ao React - V�deo explicativo sobre os fundamentos do React.'),
(2, 2, 'Guia de UX - PDF sobre melhores pr�ticas de design de experi�ncia de utilizador.'),
(3, 3, 'O que s�o APIs RESTful - Artigo sobre as defini��es e boas pr�ticas para APIs REST.'),
(4, 4, 'Sess�o ao vivo sobre ORM - Webinar sobre configura��o e uso de ORM em aplica��es.'),
(5, 5, 'Infogr�fico sobre Flutter - Visualiza��o interativa sobre os principais componentes do Flutter.'),
(6, 1, 'Explora��o de m�quinas virtuais - V�deo explicativo sobre m�quinas virtuais e suas aplica��es.'),
(7, 2, 'VPNs e seguran�a - PDF explicando o funcionamento e import�ncia das VPNs.'),
(8, 3, 'Pentesting b�sico - Artigo com introdu��o ao conceito de pentesting e suas t�cnicas.'),
(9, 4, 'Webinar sobre Suporte T�cnico - Webinar ao vivo sobre como fornecer suporte t�cnico eficiente.'),
(10, 5, 'Infogr�fico sobre Intelig�ncia Artificial - Infogr�fico interativo sobre IA e suas aplica��es.'); 
...
INSERT INTO INSCRICOES (
   ID_UTILIZADOR, ID_FORMANDO, ID_CURSO, DATA_LIMITE, DATA_INICIO_INSC, STATUS_INSCRICAO
) VALUES
(1, 1, 1, '2024-05-01 23:59:59', '2024-04-01 09:00:00', 1),
(2, 2, 2, '2024-05-01 23:59:59', '2024-04-01 10:00:00', 1),
(5, 10, 3, '2024-06-10 23:59:59', '2024-05-10 08:30:00', 1),
(4, 4, 4, '2024-06-10 23:59:59', '2024-05-12 14:00:00', 1),
(5, 5, 5, '2024-07-15 23:59:59', '2024-06-01 13:00:00', 0),
(1, 1, 4, '2024-08-20 23:59:59', '2024-07-05 11:15:00', 1),
(2, 7, 4, '2024-08-20 23:59:59', '2024-07-07 15:45:00', 0),
(1, 6, 5, '2024-09-30 23:59:59', '2024-08-01 09:30:00', 1),
(4, 4, 5, '2024-09-30 23:59:59', '2024-08-02 10:00:00', 1),
(3, 3, 3, '2024-07-15 23:59:59', '2024-06-10 12:00:00', 0);
...
INSERT INTO SINCRONO (
   ID_CURSO, ID_UTILIZADOR, ID_FORMADOR,
...
(1, 1, 1, 1, 1, 1, 1, 'Excel Avan�ado', 'Curso de Excel', 25, '2024-05-01', '2024-06-01', 1, 1, 'Portugu�s', 20, 15, NULL, 2),
(2, 2, 2, 2, 2, 2, 2, 'Power BI', 'Visualiza��o dados', 30, '2024-05-10', '2024-06-10', 1, 1, 'Portugu�s', 25, 20, NULL, 3),
(3, 3, 3, 3, 3, 3, 3, 'Python B�sico', 'Introdu��o', 20, '2024-04-20', '2024-05-20', 1, 1, 'Portugu�s', 30, 18, NULL, 2),
(4, 4, 4, 4, 4, 4, 4, 'Java Interm�dio', 'POO com Java', 15, '2024-06-01', '2024-07-01', 1, 1, 'Portugu�s', 35, 12, NULL, 1),
(5, 5, 5, 5, 5, 5, 5, 'C# Avan�ado', 'Apps Desktop', 10, '2024-07-01', '2024-08-01', 1, 1, 'Portugu�s', 40, 8, NULL, 2),
(1, 1, 1, 1, 1, 1, 1, 'Excel Interm�dio', 'Gr�ficos e f�rmulas', 20, '2024-08-01', '2024-09-01', 1, 1, 'Portugu�s', 18, 17, NULL, 2),
(2, 2, 2, 2, 2, 2, 2, 'SQL', 'Bases de dados', 18, '2024-09-05', '2024-10-05', 1, 1, 'Portugu�s', 22, 14, NULL, 3),
(3, 3, 3, 3, 3, 3, 3, 'HTML & CSS', 'Front-end', 16, '2024-10-10', '2024-11-10', 1, 1, 'Portugu�s', 20, 15, NULL, 2),
(4, 4, 4, 4, 4, 4, 4, 'JavaScript', 'Interativo', 12, '2024-11-15', '2024-12-15', 1, 1, 'Portugu�s', 25, 10, NULL, 1),
(5, 5, 5, 5, 5, 5, 5, 'C++', 'Programa��o avan�ada', 14, '2025-01-01', '2025-02-01', 1, 1, 'Portugu�s', 28, 13, NULL, 2);
