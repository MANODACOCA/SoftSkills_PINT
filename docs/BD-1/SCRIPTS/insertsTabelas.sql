...
(1, 1, 1, 1, 1, 'Curso React', 'Base React JS', 20, '2024-05-01', '2024-06-01', 2, 1, 'Português', 40.0, 5, 'react.jpg'),
(2, 2, 2, 1, 1, 'Curso UX/UI', 'Design para apps', 15, '2024-04-20', '2024-05-20', 2, 1, 'Português', 30.0, 3, 'uxui.jpg'),
(3, 3, 3, 2, 2, 'API RESTful', 'Integrações web', 25, '2024-04-15', '2024-05-15', 2, 1, 'Português', 35.0, 6, 'api.jpg'),
(4, 4, 4, 2, 2, 'ORM Avançado', 'Frameworks ORM', 10, '2024-06-01', '2024-07-01', 1, 1, 'Português', 20.0, 2, 'orm.jpg'),
(5, 5, 5, 3, 3, 'Flutter Mobile', 'Apps multiplataforma', 18, '2024-05-10', '2024-06-10', 3, 1, 'Português', 38.0, 4, 'flutter.jpg'),
(6, 1, 1, 4, 4, 'Virtualização', 'Servidores virtuais', 12, '2024-05-05', '2024-06-05', 2, 1, 'Português', 25.0, 4, 'vm.jpg'),
(7, 2, 2, 5, 5, 'VPN Segura', 'Proteção de redes', 20, '2024-05-15', '2024-06-20', 1, 1, 'Português', 28.0, 3, 'vpn.jpg'),
(8, 3, 3, 5, 6, 'Teste Penetração', 'Segurança ativa', 15, '2024-05-02', '2024-06-12', 2, 1, 'Português', 32.0, 2, 'pentest.jpg'),
(9, 4, 4, 2, 8, 'Suporte Remoto', 'Assistência técnica', 30, '2024-04-25', '2024-05-25', 2, 1, 'Português', 26.0, 5, 'suporte.jpg'),
(10, 5, 5, 3, 10, 'Redes Neuronais', 'IA aplicada', 10, '2024-06-01', '2024-07-10', 3, 1, 'Português', 40.0, 1, 'neural.jpg');
...
(3, 'Tiago Costa', 'tcosta$$', '2024-01-20 09:05:00', 914567890, 1, 'Rua do Carmo, 12', 'Portugal', '1995-11-02', 'tiago.costa@email.pt', NULL, 0, 'Cibersegurança', 'Trabalhou em projetos de segurança digital'),
...
(1, 1, 1, 1, 1, 1, 1, 'Excel Avançado', 'Curso de Excel', 25, '2024-05-01', '2024-06-01', 1, 1, 'Português', 20, 15, NULL, 2),
(2, 2, 2, 2, 2, 2, 2, 'Power BI', 'Visualização dados', 30, '2024-05-10', '2024-06-10', 1, 1, 'Português', 25, 20, NULL, 3),
(3, 3, 3, 3, 3, 3, 3, 'Python Básico', 'Introdução', 20, '2024-04-20', '2024-05-20', 1, 1, 'Português', 30, 18, NULL, 2),
(4, 4, 4, 4, 4, 4, 4, 'Java Intermédio', 'POO com Java', 15, '2024-06-01', '2024-07-01', 1, 1, 'Português', 35, 12, NULL, 1),
(5, 5, 5, 5, 5, 5, 5, 'C# Avançado', 'Apps Desktop', 10, '2024-07-01', '2024-08-01', 1, 1, 'Português', 40, 8, NULL, 2),
(1, 1, 1, 1, 1, 1, 1, 'Excel Intermédio', 'Gráficos e fórmulas', 20, '2024-08-01', '2024-09-01', 1, 1, 'Português', 18, 17, NULL, 2),
(2, 2, 2, 2, 2, 2, 2, 'SQL', 'Bases de dados', 18, '2024-09-05', '2024-10-05', 1, 1, 'Português', 22, 14, NULL, 3),
(3, 3, 3, 3, 3, 3, 3, 'HTML & CSS', 'Front-end', 16, '2024-10-10', '2024-11-10', 1, 1, 'Português', 20, 15, NULL, 2),
(4, 4, 4, 4, 4, 4, 4, 'JavaScript', 'Interativo', 12, '2024-11-15', '2024-12-15', 1, 1, 'Português', 25, 10, NULL, 1),
(5, 5, 5, 5, 5, 5, 5, 'C++', 'Programação avançada', 14, '2025-01-01', '2025-02-01', 1, 1, 'Português', 28, 13, NULL, 2);
