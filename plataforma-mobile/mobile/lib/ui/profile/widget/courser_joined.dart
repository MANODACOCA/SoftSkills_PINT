            ...
            children: [
              Row(
                children: [
                  ...
                  SizedBox(width: 10),
                  Text('Cursos assíncrono', style: TextStyle(fontSize: 20)),
                  Spacer(),
                  IconButton(
                    onPressed: () {},
              ...
              Row(
                children: [
                  ...
                  SizedBox(width: 10),
                  Text('Cursos síncrono', style: TextStyle(fontSize: 20)),
                  Spacer(),
                  IconButton(
                    onPressed: () {},
                    icon: Icon(Icons.arrow_forward_ios),
              ...
              SizedBox(height: 20),
              Text('Lista de Cursos Inscritos', style: TextStyle(fontSize: 24)),
            ],
          ),
        ),
      ),
