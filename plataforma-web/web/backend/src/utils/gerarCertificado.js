...
//     <img class="logo" src="[LOGO_URL]" alt="Logo da Empresa">
...
// <div class="conteudo">
//   <div class="nome-formando">[NOME DO FORMANDO]</div>
//   concluiu, com aproveitamento, o curso <span class="curso">"[NOME DO CURSO]"</span>, realizado no período de 
//   <strong>[DATA DE INÍCIO]</strong> a <strong>[DATA DE FIM]</strong>, tendo obtido a classificação final de <strong>[NOTA]</strong>.
//   <br /><br />
...
// <div class="rodape">
//   Emitido em [DATA DE EMISSÃO] &nbsp;•&nbsp; https://softskills-three.vercel.app/
// </div>
